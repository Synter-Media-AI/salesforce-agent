...
Manage Salesforce CRM data with AI agents via MCP.

 `salesforce` `crm` `enterprise-sales` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage Salesforce — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> Sync Salesforce contacts to ad audiences

> Pull pipeline metrics

> Export accounts for LinkedIn Matched Audiences

> Create a lead from campaign data
